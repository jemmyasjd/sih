...
export default function Example() {
  ...
  return (
    <div>
                      ...
                      {people.map((person, personIdx) => (
                        ...
                        >
                          ...
                          <td className="relative pl-20">
                             <a href="#" onClick={handleClickHere} className="text-indigo-600 hover:text-indigo-900">
      ...
      {showKeyboard && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-10 flex items-center justify-center z-50 pt-96">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg p-8 relative max-w-lg w-full shadow-lg">
            <button
              onClick={closeModal}
            ...
            <p>This is a card displaying the content you clicked for.</p>
          </div>
        </div>
      )}
    </div>
